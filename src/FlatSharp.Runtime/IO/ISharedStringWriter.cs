...
public interface ISharedStringWriter
{
    ...
    /// <returns>The location in the buffer of the string</returns>
    int WriteSharedString<TSpanWriter>(TSpanWriter spanWriter, Span<byte> data, string value, SerializationContext context)
