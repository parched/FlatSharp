...
public class MemoryVectorTypeModel : BaseVectorTypeModel
{
    ...
    {
        string body =
            $"return {context.SpanWriterVariableName}.{nameof(SpanWriterExtensions.WriteReadOnlyByteMemoryBlock)}({context.SpanVariableName}, {context.ValueVariableName}, {context.SerializationContextVariableName});";
